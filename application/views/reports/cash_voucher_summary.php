...
?>
<style type="text/css">
tr td:nth-child(4), tr td:nth-child(6) { text-align: right; }
</style>
...
<div class="content-inner" id="pageActive" data-num="10" data-namecollapse="" data-labelname="PO Listing Report"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Cash Voucher Summary</li>
        </ol>
    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row" style="float:right;">
                                        <div>
                                                ...
                                                <form action="<?php echo base_url('main_reports/cash_voucher_export');?>" method="post" target="_blank"> 

                                                <input id="datefrom1" type="text" class="input-sm form-control" name="datefrom1" hidden  >
...
<script type="text/javascript" src="<?=base_url('assets/js/reports/cash_voucher_summary.js');?>"></script>
