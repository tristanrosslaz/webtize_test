...
<div class="content-inner" id="pageActive" data-num="10" data-namecollapse="" data-labelname="PO Listing Report"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Purchases Order Listing Report</li>
        </ol>
    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row" style="float:right;">
                                        <div>
                                                ...
                                                <form action="<?php echo base_url('main_reports/po_report_export');?>" method="post" target="_blank"> 
...
<script type="text/javascript" src="<?=base_url('assets/js/reports/po_listing_report.js');?>"></script>
