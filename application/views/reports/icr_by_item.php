...
<div class="content-inner" id="pageActive" data-num="10" data-namecollapse="" data-labelname="Inventory Consumption Report (By Item)"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Inventory Consumption Report (By Item)</li>
        </ol>
    </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/reports/icr_by_item.js');?>"></script>
