...
<div class="content-inner" id="pageActive" data-num="10" data-namecollapse="" data-labelname="Sales Report by Franchisee"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Sales Report by Franchisee</li>
        </ol>
    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                              ...
                                              <select class="form-control col-md-8 select2" name="customer" id="location">
                                               ...
                                               <?php foreach ($get_customer->result() as $b) { ?>
                                                    <option value="<?= $b->idno?>">
                                                        <?php echo ($b->name)?>
                                                    </option>
                                                <?php } ?>
...
<script type="text/javascript" src="<?=base_url('assets/js/reports/srb_customer.js');?>"></script>
