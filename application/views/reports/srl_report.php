...
<div class="content-inner" id="pageActive" data-num="10" data-namecollapse="" data-labelname="Sales Return Listing Report"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
         ...
         <!--    <li class="breadcrumb-item"><a class="white-text" href="<?=base_url('Main_reports/salesreport/'.$token);?>">Sales Report</a><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li> -->
            <li class="breadcrumb-item active">Sales Return Listing Report</li>
        </ol>
    </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/reports/srl_report.js');?>"></script>
