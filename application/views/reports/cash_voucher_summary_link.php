...
<div class="content-inner" id="pageActive" data-num=10 data-namecollapse="" data-labelname="Purchase Order"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <!-- <li class="breadcrumb-item"><a class="white-text" href="<?=base_url('Main_reports/cash_voucher_summary/'.$token);?>">Cash Voucher Summary</a><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li> -->
                                            ...
                                            <div class="">
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="" >
                                                                <div class="">
                                                                    <h4 class="cvno" style="border:none; float:left;">Cash Voucher # <?=$get_summary->cvno?></h4>

                                                                    <input type="text" value="<?=$get_summary->cvno?>" id="cvno_id" hidden>
                                                                    <p><br></p>
                                                                </div>  
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <div class="">
                                                                <div class="">
                                                                    <label class="">Cash Voucher Information </label>
                                                                </div>  
                                                            </div>

                                                            <div class="">
                                                                <div class="">
                                                                    <H2><?=strtoupper($get_summary->payto)?></H2>
                                                                </div>  
                                                            </div>
                                                               ...
                                                               <!--  <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4"><label class="">Funds Date: </label></div>
                                                                    <div class="col-md-6"><span type="text" class="terms_of_payment" style="border:none;" disabled><?=$get_summary->fundsdate?></span></div>
                                                                </div>  

                                                                <div class="row">
                                                                    <div class="col-md-4"><label class="">Status: </label></div>
                                                                    <div class="col-md-6"><span type="text" class="apv_amount" style="border:none;" disabled><?=$get_summary->type?></span></div>
                                                                </div>  

                                                                <div class="row">
                                                                    <div class="col-md-4"><label class="">Created by: </label></div>
                                                                    <div class="col-md-6"><span type="text" class="apv_balance" style="border:none;" disabled><?=strtoupper($get_summary->username)?></span></div>
                                                                </div>  

                                                                <div class="row">
                                                                    <div class="col-md-4"><label class="">Approved By: </label></div>
                                                                    <div class="col-md-6"><span type="text" class="apv_status" style="border:none;" disabled><?=strtoupper($get_summary->approver)?></span></div>
                                                                </div>  
                                                              ...
                                                              <!--   <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4"><label class="">PO Amount: </label></div>
                                                                    <div class="col-md-8"><span type="text" class="apv_status" style="border:none;" disabled><?=number_format($get_summary->totalamt,2);?></span></div>
                                                                </div> -->  
                                             ...
                                             <!--            <div class="col-lg-6">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table  table-striped table-hover table-bordered" id="table-grid2"  cellpadd3ing="0" cellspacing="0" border="0" class="display" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Amount (No Receipt) </th>
                                                                    <th>Total Amount </th>
                                                                </tr>
                                                            </thead>
                                                        </table>
                                                        <!-- <button type="button" class="btn btn-default col-md-12 btnShipping" id="btnShipping" data-toggle="modal"  data-backdrop="static" data-keyboard="false" data-target="#addAShippingModal" disabled="">Subtotal: <?=number_format($get_summary->difference,2);?></button>
                                                        <input type="hidden" value= "<?=number_format($get_summary->difference,2);?>" class="form-control form-control-success shippingamt" name="shippingamt" id="shippingamt">
                                                        ...
                                                        <button class="btn btn-warning btnGrand col-md-12 grand_total disabled" id="grand_total" name="grand_total">Amount to Settle : <?=number_format($get_summary->difference,2);?></button>
                                                        <input type="hidden" value= "<?=number_format($get_summary->difference,2);?>" class="form-control form-control-success grand_total2" name="grand_total2" id="grand_total2">
                                                    </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/reports/cash_voucher_summary_link.js');?>"></script>
