                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row" style="float:right;">
                                        <div>
                                            <form action="<?php echo base_url('main_reports/si_listing_report_export');?>" method="post" target="_blank"> 
...
<script type="text/javascript" src="<?=base_url('assets/js/reports/si_listing_report.js');?>"></script>
