...
<div class="content-inner" id="pageActive" data-num="10" data-namecollapse="" data-labelname="GL Transaction Report"> 
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                                    ...
                                    <div class="row" style="padding-top: 30px;">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <form action="<?php echo base_url('main_reports/gl_tran_report_export');?>" method="post" target="_blank">
                        ...
                        <button type="button" class="btn btn-default btn-primary searchBtn" style="right:20px; position: absolute; top:20px;" id="searchBtn">Search</button>
                        <div class="card-body tbl1">
                            ...
                            <div class="table-responsive">
                                <table class="table  table-striped table-hover table-bordered" id="table-grid"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%" hidden>
                                    <thead>
                                        <tr>
                                            <th width="50%">Expense Account</th>
                                            <th>Amount</th>
                                        </tr>
                                    </thead>
                                </table>
                        ...
                        <div class="card-body tbl2">
                            ...
                            <div class="table-responsive">
                                <table class="table  table-striped table-hover table-bordered" id="table-grid2"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%" hidden>
                                    <thead>
                                        <tr>
                                            <th>Date</th>
                                            <th>Description</th>
...
<script type="text/javascript" src="<?=base_url('assets/js/reports/gl_tran_report.js');?>"></script>
