...
<div class="content-inner" id="pageActive" data-num="10" data-namecollapse="" data-labelname="Inventory List"> 
    ...
    <header class="page-header">
        <div class="container-fluid">
            <h2 class="no-margin-bottom">Inventory Transaction Report</h2>
        </div>
    </header>
    <!-- Breadcrumb-->
    <ul class="breadcrumb">
                            ...
                            <!-- <form class="form-horizontal encode-info-css encode_form" id="encode_form"> -->
                                ...
                                <div class="form-group row" style="margin-top: 30px;">       
                                    <div class="col-md-12">
                                         ...
                                         <a href="<?=base_url('main_reports/it_report/'.$token);?>" style="float:right;margin-right:10px;" class="btn btn-danger BtnBack2"><i class="fa fa-arrow-left" aria-hidden="true" ></i> Back</a>
                                    </div>
                                </div>
                          <!--   </form> -->
                       </div>
