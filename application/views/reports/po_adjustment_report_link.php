...
<div class="content-inner" id="pageActive" data-num=9 data-namecollapse="" data-labelname="Purchase Order"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <!-- <li class="breadcrumb-item"><a class="white-text" href="<?=base_url('Main_reports/po_adjustment_report/'.$token);?>">PO Adjustment Report</a><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li> -->
            <li class="breadcrumb-item active">PO Adjustment View Details</li>
        </ol>
    </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <div class="">
                                                               ...
                                                               <!--  <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4"><label class="">Date of Purchase: </label></div>
...
<script type="text/javascript" src="<?=base_url('assets/js/reports/po_adjustment_report_link.js');?>"></script>
