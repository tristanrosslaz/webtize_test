...
<div class="content-inner" id="pageActive" data-num="10" data-namecollapse="" data-labelname="Petty Cash Reimbursement Report"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active"> Petty Cash Reimbursement Report</li>
        </ol>
    </div>
                                        ...
                                        <div class="row" style="padding-top: 30px;">
                                            <div class="col-md-4 col-sm-8">
                                                <div class="form-group row">
                                                    <div class="form-group bddatediv" >
...
<script type="text/javascript" src="<?=base_url('assets/js/reports/pcr_report.js');?>"></script>
