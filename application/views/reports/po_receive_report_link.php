...
<div class="content-inner" id="pageActive" data-num=10 data-namecollapse="" data-labelname="Purchase Order"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <!-- <li class="breadcrumb-item"><a class="white-text" href="<?=base_url('Main_reports/po_receive_report/'.$token);?>">Purchase Order Receive Report</a><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li> -->
            <li class="breadcrumb-item active">Purchase Order Receive </li>
        </ol>
    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="" >
                                                                <div class="">
                                                                     <H2><?=company_name();?></H2>
                                                                    <h4 class="rcvno" style="border:none; float:left;">Receive no. <?=$get_summary->rcvno?></h4>

                                                                    <input type="text" value="<?=$get_summary->rcvno?>" class="rcvno" id="rcvno" hidden>
                                                                    <p><br></p>
                                                                </div>  
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4"><label class="">Date of Receive: </label></div>
                                                                    <div class="col-md-6"><span type="text" class="terms_of_payment" style="border:none;" disabled><?=$get_summary->itrandate?></span></div>
                                                                </div>  
...
<script type="text/javascript" src="<?=base_url('assets/js/reports/po_receive_report_link.js');?>"></script>
