                    ...
                    <div id="collectdiv" class="col-md-12 form-collect" style="background-color: #fff !important;">
                        ...
                        <div class="p-4">
                            <div class="form-group">
                                <input type="text" name="f1_date" id="f1_date" readonly="true" class="form-control datepicker" value="<?=today_date();?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <select class="form-control" id="f1_classification">
                                    <option selected value="">Select Classification</option>
                                    <option  value="Construction Materials"> Construction Materials </option>
                                    <option  value="Finished Goods Yield"> Finished Goods Yield </option>
                                    <option  value="Finished Goods Yield"> Finished Goods Yield </option>
                                    <option  value="Ingredients Yield"> Ingredients Yield </option>
                                    <option  value="Spoilages"> Spoilages </option>
                                </select>
                            </div>
                            <div class="form-group">
                                <input type="text" name="f1_build_no" id="f1_build_no" class="form-control" placeholder="Build Number" value="0" style="display:none;">
                            </div>
                            <div class="form-group">
    ...
    <section class="tables" id="div_2" style="display: none;">   
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <h6 class="secondary-bg px-4 py-3 white-text">Inventory Adjustment Information</h6>
                        <div class="card-header d-flex align-items-center">
                            <div class="col-12 col-md-6">
                                <label>Date of Transfer:</label><label id="lbl_date"></label><br/>
                                <label>Location Transfer:</label><label id="lbl_from_loc"></label><br/>
                                <label>Type:</label><label id="lbl_type"></label><br/>
                                <label>Classification:</label><label id="lbl_classification"></label><br/>
                                <label id="lbl_build_number0">Build Number:</label><label id="lbl_build_number"></label><br/>
                            </div>
                        </div>
                        <div class="card-body">
...
<script type="text/javascript" src="<?=base_url('assets/js/inventory/inventory_adjustment.js');?>"></script>