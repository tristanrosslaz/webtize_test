...
<div class="content-inner" id="pageActive" data-num="4" data-namecollapse="" data-labelname="Inventory List"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Inventory Location Transfer</li>
        </ol>
    </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-12 center_margin">
                    <div id="collectdiv" class="col-md-12 form-collect" style="background-color: #fff !important;">
                        <h6 class="px-4 py-3 primary-bg white-text">Inventory Location Transfer Information</h6>
                        <div class="p-4">
                            <div class="form-group">
                                <input type="text" name="f1_date" id="f1_date" readonly="true" class="form-control datepicker-before" value="<?=today_date();?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <select class="form-control" id="f1_to_location">
    ...
    <section class="tables" id="div_2" style="display:none;">   
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <h6 class="secondary-bg px-4 py-3 white-text">Inventory Location Transfer Information</h6>
    ...
    <div id="addItemModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog modal-lg-4">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 id="exampleModalLabel" class="modal-title">Add Item</h4>
                </div>
                <form class="form-horizontal personal-info-css" id="add_inventory_entry_modal" method="post" action="">
                            ...
                            <div class="col-lg-12">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input id="f2_quantity" type="number" min="0" class="form-control" name="f2_quantity" placeholder="0.00">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/inventory/inventory_location_transfer.js');?>"></script>
