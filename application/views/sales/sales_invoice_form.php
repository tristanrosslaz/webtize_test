...
<div class="content-inner" id="pageActive" data-num="2" data-namecollapse="#ewallet-collapse-a" data-labelname="Sales Order">
    ...
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Add Sales Invoice</li>
                            ...
                            <div class="card-progress">
                                <form class="form-horizontal encode-info-css sales_form" id="sales_form">
                                    ...
                                    <div class="col-lg-12 padding-0_mobile">
                                                    ...
                                                    <div class="card h-100">
                                                        ...
                                                        <div class="p-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input  type="text" value="<?=today_text()?>" class="form-control form-control-warning sales_date" id="sales_date" name="sales_date" readonly required/>
                                                            </div>
                                                            <div class="form-group">
                                        ...
                                        <div class="step2" style="display: none;">
                                            <div class="card">
                                                ...
                                                <hr>        
                                                    <button type="button" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#addAOrderItemModal" class="btn btn-primary btnUpdate btnTable" id="addsalesorder" name="update" >Add Service</button>
                                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <button hidden style="float: right;" id="BtnSaveProceedWithEmail"  onclick="show_info()" class="btn btn-primary BtnSaveProceedWithEmail"> Save and Email</button>
                                    ...
                                    <form id="addRow">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control allownumericwithdecimal so_required_fields form-control-sm col-md-12 price" name="price" id="price" oninput="validity.valid||(value='');" min="" placeholder="Price">
                                                </div>
                                            </div>
...
<!-- Paypanda payment form -->
    <form method="post" id="transaction_entry_form" style="display:none">
	<table>
		<tr>
			<td>Merchant ID</td>
			<td><input type="text" value="PB" name="merchant_id" id="merchant_id"></td>
		</tr>
		<tr>
			<td>Reference Number</td>
			<td><input type="text" name="f_reference_text" id="f_reference_text" value="<?=$sino?>"></td>
		</tr>
		<tr>
			<td>Amount</td>
			<td><input type="text" name="f_amount" id="f_amount"></td>
		</tr>
		<tr>
			<td>Remarks</td>
			<td><input type="text" name="f_remarks" id="f_remarks" value="SI Payment"></td>
		</tr>
		<tr>
			<td>Signature</td>
		...
		<tr>
			<td>Send Email</td>
			<td><input type="checkbox" name="f_send_email" id="f_send_email" checked></td>
		</tr>
		<tr >
			<td colspan="2">
				<button id="generate_signature_btn" type="button">Post</button>
			</td>
		</tr>
	</table>
...
<script src="<?=base_url('assets/js/sales/sales_invoice_form.js');?>"></script>
