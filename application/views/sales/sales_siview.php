    ...
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
          ...
          <?php } else if($directsales == "drtag") { ?>
            ...
            <li class="breadcrumb-item"><a class="white-text" href="<?=base_url('Main_sales/sales_drtagginghistory/'.$token);?>">Delivery Receipt</a><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>

           <?php } ?>

            <li class="breadcrumb-item active">Delivery Receipt # <?=$get_infosummary->drno?></li>
        </ol>
    </div>
                                                      ...
                                                      <p>Packing:</p>
                                                         <table class="table">
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td>
                                                                <?php  if(empty($get_packing->drybox)){
                                                                  echo 'none';
                                                                }else{
                                                                  echo $get_packing->drybox;
                                                                } ?></td>

                                                                 <td>
                                                                <?php  if(empty($get_packing->drybag)){
                                                                  echo 'none';
                                                                }else{
                                                                  echo $get_packing->drybag;
                                                                } ?></td>

                                                                 <td>
                                                                <?php  if(empty($get_packing->pershbox)){
                                                                  echo 'none';
                                                                }else{
                                                                  echo $get_packing->pershbox;
                                                                } ?></td>

                                                                 <td>
                                                                <?php  if(empty($get_packing->pershbag)){
                                                                  echo 'none';
                                                                }else{
                                                                  echo $get_packing->pershbag;
                                                                } ?></td>
...
<script type="text/javascript" src="<?=base_url('assets/js/sales/sales_viewsi.js');?>"></script>
