...
<div class="content-inner contento" id="pageActive" data-num="2" data-namecollapse="#ticket-collapse" data-labelname="Sales Return Transaction History"> 
  <div class="bc-icons-2 card mb-4">
    <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
      ...
      <li class="breadcrumb-item active">Sales Return Transaction History</li>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <select id="searchfilter" class="form-control searchfilter">
                          ...
                          <option value="nodiv">Search by DR Return No</option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="datediv" id="datediv">
                          ...
                          <div class="input-daterange input-group" id="datepicker">
                            <input type="text" class="input-sm form-control search-input-select1 dateFrom" value="<?=today_text();?>" name="start" readonly />
                            <span class="input-group-addon" style="background-color:#fff; border:none;">&nbsp;to&nbsp;</span>
                            <input type="text" value="<?=today_text();?>" class="input-sm form-control search-input-select2 dateTo" name="end" readonly/>    
                          </div>   
                        </div>

                        <div class="nodiv" id="nodiv" style="display: none;">
                          <label class="form-control-label col-form-label-sm">Return No.</label>
                          <input type="text" class="input-sm form-control search-input-text searchNo allownumericwithoutdecimal" id="searchNo" placeholder="1234" /> 
                        </div>

                        <div class="statusdiv" id="statusdiv" style="display: none;">
                          <label class="form-control-label col-form-label-sm">Status</label>
                          <select id="searchStatus" class="input-sm form-control material_josh search-input-text searchStatus" >
                        ...
                        <?php
                          ...
                          if ($searchArray[0] == "SRtran") { // check first if the session data is meant for PO Approval ?>
                            ...
                            <span id="hdnDrretno" hidden=""><?=$this->session->userdata('drretno');?></span>
                        ...
                        <?php }
                            ...
                            <span id="hdnDrretno" hidden=""></span>
                            <span id="hdnStatus" hidden=""></span>
                          <?php }
                          $array_items = array('search', 'datefrom', 'dateto', 'drretno', 'status');
...
<script type="text/javascript" src="<?=base_url('assets/js/sales/salesreturn_summary.js');?>"></script>
