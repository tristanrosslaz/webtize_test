...
<div class="content-inner" id="pageActive" data-num="2" data-namecollapse="#ticket-collapse" data-labelname="Sales"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item"><a class="white-text" href="<?=base_url('Main_sales/credit_memosummary/'.$token); ?>">Credit Memo Transaction History</a><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>
            <li class="breadcrumb-item active">Credit Memo # <?=$get_infosummary->id?></li>
        </ol>
    </div>
                                 ...
                                 <div class="form-group row">
                                    <div class="col-md-6">
                                            <div class="form-group p-style">
                                                <div class="row">
                                                    <div class="col-md-12"><n style="margin-left: 133px;"><h4><?php echo concatenate_name($get_edit_membermain->fname, $get_edit_membermain->mname, $get_edit_membermain->lname, $get_edit_membermain->branchname);?></h4></div>
...
<script type="text/javascript" src="<?=base_url('assets/js/sales/credit_memoview.js');?>"></script>
