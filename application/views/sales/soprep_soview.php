...
<div class="content-inner" id="pageActive" data-num="2" data-namecollapse="#ticket-collapse" data-labelname="Sales"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item"><a class="white-text" href="<?=base_url('Main_sales/sales_order_preparation/'.$token);?>">Sales Order Preparation</a><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>
...
<script type="text/javascript" src="<?=base_url('assets/js/sales/dr_soview.js');?>"></script>
