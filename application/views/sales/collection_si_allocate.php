<style>
   ...
   td.dt-body-right, td.dt-body-right input { text-align: right; }
</style>
...
<div class="content-inner" id="pageActive" data-num="2" data-namecollapse="#ticket-collapse" data-labelname="Sales">
   <div class="bc-icons-2 card mb-4">
      <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
         ...
         <li class="breadcrumb-item active">Collection Allocate (Sales Invoice)</li>
      </ol>
   </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/sales/collection_si_allocate.js');?>"></script>
