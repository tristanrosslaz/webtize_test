...
<div class="bc-icons-2 card mb-4">
   <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
      ...
      <li class="breadcrumb-item active">Credit Memo Allocate</li>
   </ol>
</div>
                  ...
                  <div class="card-body">
                     <div class="row" style="margin-bottom: 20px;">
                        <div class="col-md-8 text-uppercase text-primary">
                           <h4 style="margin-top: 8px;"><i class="fa fa-user"></i> <?php echo concatenate_name($get_edit_membermain->fname, $get_edit_membermain->mname, $get_edit_membermain->lname); ?></h4>
                        </div>
                        <div class="col-md-4" style="text-align: right;"> 
                           <button class="btn btn-primary pull-right" id="allocateBtn" disabled type="submit"> Allocate Now</button>
                           <a href="<?=base_url('Main_sales/credit_memosummary/'.$token);?>" style="float:right;margin-right:10px;" class="btn btn-secondary BtnBack2"> Back</a>
                        </div>
                     </div>
                     <div class="form-group row">
                        <div class="col-md-4">
                           <ul class="list-group">
                              <li class="list-group-item active">Credit Memo Details</li>
...
<script type="text/javascript" src="<?=base_url('assets/js/sales/credit_memoallocate.js');?>"></script>
