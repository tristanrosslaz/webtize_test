...
<div class="content-inner" id="pageActive" data-num="2" data-namecollapse="#ticket-collapse" data-labelname="Sales"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item"><a class="white-text" href="<?=base_url('Main_sales/salesreturn_summary/'.$token);?>">Sale Return Transaction History</a><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>
            <li class="breadcrumb-item active">Sales Return Allocate</li>
        </ol>
    </div>
                                 ...
                                 <div class="card-body">
                                     <div class="row" style="margin-bottom: 20px;">
                                      ...
                                      <div class="col-md-4" style="text-align: right;"> 
                                          ...
                                          <a href="<?=base_url('Main_sales/salesreturn_summary/'.$token);?>" style="float:right;margin-right:10px;" class="btn blue-grey BtnBack2"> Back</a>
                                        </div>
                                      </div>
                                 <div class="form-group row">
                                    <div class="col-md-4">
                                            <ul class="list-group">
                                              ...
                                              <li class="list-group-item active">Sales Return Details</li>
                                              ...
                                              <li class="list-group-item d-flex justify-content-between align-items-center">
                                                Balance
                                                <span class="badge badge-warning badge-pill"><?php echo number_format($get_drretbalance,2,".",",") ?></span>
                                              </li>
                                              <li class="list-group-item d-flex justify-content-between align-items-center">
                                                Allocation
                                                <span class="badge badge-warning badge-pill" id="allocLabel">0.00</span>
                                              </li>
                                              <input value="<?=$get_drretbalance?>" type="" id="retbalance" name="retbalance" hidden/>
                                              <input value="<?=$get_infosummary->drretno;?>" type="" id="drretno" name="drretno" hidden/>
                                            </ul>
                                    </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/sales/salesreturn_allocate.js');?>"></script>
