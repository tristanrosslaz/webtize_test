                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group p-style">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8"><h4><?=concatenate_name($get_edit_membermain->fname, $get_edit_membermain->mname, $get_edit_membermain->lname, $get_edit_membermain->branchname);?></h4></div>
                                        </div>
