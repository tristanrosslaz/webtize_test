...
<div class="content-inner" id="pageActive" data-num="2" data-namecollapse="#ticket-collapse" data-labelname="Sales"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">FSR Collection Allocate</li>
        </ol>
    </div>
                                 ...
                                 <div class="card-body">
                                     <div class="row" style="margin-bottom: 20px;">
                                      ...
                                      <div class="col-md-4" style="text-align: right;"> 
                                        ...
                                        <a href="<?=base_url('Main_sales/fsr_collection_summary/'.$token);?>" style="float:right;margin-right:10px;" class="btn blue-grey BtnBack2"> Back</a>
                                      </div>
                                      </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/sales/fsrcollection_allocate.js');?>"></script>
