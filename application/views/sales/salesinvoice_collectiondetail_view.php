                                ...
                                <div class="col-md-6">
                                    <div class="form-group p-style">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9"><h4><?php echo strtoupper($get_edit_membermain->lname) . ", " . strtoupper($get_edit_membermain->fname) . " " . strtoupper($get_edit_membermain->mname) ?></h4></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">Date: <n style="margin-left: 133px;"><?php echo $get_infosummary->trandate?></n></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">Branch: <n style="margin-left: 116.4px;"><?=$get_edit_credit->branchname?></n></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">Mode of Payment: <n style="margin-left: 48.6px;"><?php echo $get_edit_credit->description?></n></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">Contact No: <n style="margin-left: 92px;"><?php echo $get_edit_membermain->conno?></n></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">Outlet Address: <n style="margin-left: 69px;"><?=$get_edit_membermain->address?></n></div>
                                        </div>
                                        <!-- HIDDEN FIELDS -->
...
<script type="text/javascript" src="<?=base_url('assets/js/sales/salesinvoice_collectiondetail_view.js');?>"></script>
