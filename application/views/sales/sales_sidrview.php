                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group p-style">
                                        ...
                                        <input disabled type="hidden" class="form-control form-control-success term_credit" name="term_credit" id="term_credit" value="<?=$getSummary->termcredit?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group p-style">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9"><h4><?php if(!empty($getSummary)){ echo date_format(date_create($getSummary->trandate),"m/d/Y");}?></h4></div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9"><p><?=$getLocation->location ?></p></div>
                                            </div>
                                        </div>
                                    </div>      
                            ...
                            <div class="">    
                                <div class="col-md-3" style="float: right; padding-right: 0px;">
                                    ...
                                    <button type="button" class="btn btn-block ml-0 mb-2 border-deco-left blue-grey" data-toggle="modal" data-target="#" style="width: 100%; font-size: 15px; padding-right: 0px; line-height: 20px;" id="" ><i class="fa fa-truck white-text fa-lg" style="float: left; margin-left: -18px; margin-top: 10px;"></i><a class="btnShipping">Shipping: <?=number_format($getSummary->freight,2,".",",") ?></a></button>
                                    ...
                                    <input type="hidden" value= "<?=$getSummary->totalamt?>" class="form-control form-control-success grand_total2" name="grand_total2" id="grand_total2">

                                    <input type="hidden" value= "<?=$getSummary->freight?>" class="form-control form-control-success shippingamt" name="shippingamt" id="shippingamt">
                                </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/sales/sales_sidrview.js');?>"></script>
