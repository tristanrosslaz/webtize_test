...
<div class="content-inner" id="pageActive" data-num="7" data-namecollapse="#ticket-collapse" data-labelname="Purchase"> 
...
<!--             <li class="breadcrumb-item"><a class="white-text" href="<?=base_url('Main_page/display_page/home/'.$token); ?>">Home</a><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li> -->
            ...
            <li class="breadcrumb-item active">PO Payment Allocate Using Check</li>
        </ol>
    </div> 
...
<script type="text/javascript" src="<?=base_url('assets/js/account/popayment_allocate.js');?>"></script>
