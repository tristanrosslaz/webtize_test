...
<div class="content-inner" id="pageActive" data-num="7" data-namecollapse="" data-labelname="Inventory List"> 
    ...
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item"><a class="white-text" href="<?=base_url('Main_account/apvpo_edit/' . $token . '/' . $apvno->apvno);?>">Edit Accounts Payable Voucher</a><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="" >
                                                                <div class="">
                                                                    ...
                                                                    <h1 class="pono" style="border:none; float:left;"><?=$pono?></h1>
                                                                    <p><br></p>
                                                                </div>  
                                                            </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/account/apv_listrcvno.js');?>"></script>
