...
<div class="content-inner" id="pageActive" data-num="7" data-namecollapse="" data-labelname="Inventory List"> 
    ...
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item"><a class="white-text" href="<?=base_url('account/APV_list/apvno_log/' . $token . '/' . $apvno->apvno);?>">Accounts Payable Voucher</a><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>
