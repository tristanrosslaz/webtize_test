...
<div class="content-inner" id="pageActive" data-num="3" data-namecollapse="#settings-collapse" data-labelname="Branch Operator"> 
    <!-- Page Header-->
    <header class="page-header">
        <div class="container-fluid">
            <h2 class="no-margin-bottom">Branch Operator</h2>
        </div>
    </header>
    <!-- Breadcrumb-->
    <ul class="breadcrumb">
        <div class="container-fluid">
            ...
            <li class="breadcrumb-item active">Branch Operator</li>
        </div>
    </ul>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <select  data-column="0" class="form-control select2 search-input-select searchBranch">
                                                <!-- //ajax load -->                
                                                </select>
                                            </div>
                                        </div>
        ...
        <div role="document" class="modal-dialog modal-lg modal-lg-custom">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 id="exampleModalLabel" class="modal-title">Add Branch Operator</h4>
                                ...
                                <div class="col-lg-12">
                                    <div class="">
                                        <div class="card-body">
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-control select2 info_position" name="info_position">
                                                        ...
                                                        foreach ($get_position->result() as $gpos) { ?>
                                                            <?php if($gpos->position == "Player" || $gpos->position == "Staff" || $gpos->position == "Admin" || $gpos->position == "Staff(Admin)" ){}else{?>
                                            ...
                                            <div class="form-group row">
                                                <br>
                                                <label class="col-md-2 form-control-label">Company Name <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-10">
                                                    <input id="inputHorizontalWarning" type="text" class="form-control form-control-warning" name="branch_info_companyname">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <br>
                                                ...
                                                <div class="col-md-4">
                                                    <input id="inputHorizontalWarning" type="text" class="form-control form-control-warning" name="branch_info_branchname">
                                                </div>
                                                <label class="col-md-2 form-control-label">Branch Contact No. <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <input id="inputHorizontalWarning" type="text" class="form-control form-control-warning" name="branch_info_conno">
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                                <br>
                                                <label class="col-md-2 form-control-label">Branch Area <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-10">
                                                    <input id="inputHorizontalWarning" type="text" class="form-control form-control-warning" name="branch_info_area">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input id="inputHorizontalWarning" type="text" class="form-control form-control-warning" name="branch_info_address">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-2 form-control-label">Country <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <select class="form-control select2 branch_info_country" name="branch_info_country">
                                                        <?php
                                                        foreach ($get_country->result() as $gcountry) { ?>
                                                                <option value="<?=$gcountry->country_id?>"><?=$gcountry->country?></option>
                                                        <?php } ?>
                                                ...
                                                <label class="col-md-2 form-control-label">City <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <select class="form-control select2 branch_info_city" name="branch_info_city">
                                                        <option selected value="">-- Select City --</option>
                                                        <?php
                                                        foreach ($get_city->result() as $gcity) { ?>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-2 form-control-label">Start Contract <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <input id="inputHorizontalWarning" type="text" class="form-control form-control-warning datepicker" name="branch_info_start_contract" placeholder="mm/dd/yyyy" value="<?=today_text()?>">
                                                </div>

                                                <label class="col-md-2 form-control-label">End Contract <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <input id="inputHorizontalWarning" type="text" class="form-control form-control-warning datepicker" name="branch_info_end_contract" placeholder="mm/dd/yyyy" value="<?=today_text()?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="col-md-2 form-control-label">Company Name <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-10">
                                                    <input disabled id="inputHorizontalWarning" type="text" class="form-control form-control-warning branch_info_companyname" name="branch_info_companyname">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <br>
                                                <label class="col-md-2 form-control-label">Branch Name <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <input disabled id="inputHorizontalWarning" type="text" class="form-control form-control-warning branch_info_branchname" name="branch_info_branchname">
                                                </div>
                                                <label class="col-md-2 form-control-label">Branch Contact No. <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <input disabled id="inputHorizontalWarning" type="text" class="form-control form-control-warning branch_info_conno" name="branch_info_conno">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="col-md-2 form-control-label">Branch Area <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-10">
                                                    <input disabled id="inputHorizontalWarning" type="text" class="form-control form-control-warning branch_info_area" name="branch_info_area">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="col-md-2 form-control-label">Branch Address <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-10">
                                                    <input disabled id="inputHorizontalWarning" type="text" class="form-control form-control-warning branch_info_address" name="branch_info_address">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-2 form-control-label">Country <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <select disabled class="form-control select2 branch_info_country" name="branch_info_country">
                                                        <?php
                                                        foreach ($get_country->result() as $gcountry) { ?>
                                                                <option value="<?=$gcountry->country_id?>"><?=$gcountry->country?></option>
                                                        <?php } ?>
                                                ...
                                                <label class="col-md-2 form-control-label">City <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <select disabled class="form-control select2 branch_info_city" name="branch_info_city">
                                                        <option selected value="">-- Select City --</option>
                                                        <?php
                                                        foreach ($get_city->result() as $gcity) { ?>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-2 form-control-label">Start Contract <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <input disabled id="inputHorizontalWarning" type="text" class="form-control form-control-warning datepicker branch_info_start_contract" name="branch_info_start_contract" placeholder="mm/dd/yyyy">
                                                </div>

                                                <label class="col-md-2 form-control-label">End Contract <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <input disabled id="inputHorizontalWarning" type="text" class="form-control form-control-warning datepicker branch_info_end_contract" name="branch_info_end_contract" placeholder="mm/dd/yyyy">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="col-md-2 form-control-label">Company Name <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-10">
                                                    <input id="inputHorizontalWarning" type="text" class="form-control form-control-warning branch_info_companyname" name="branch_info_companyname">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <br>
                                                <label class="col-md-2 form-control-label">Branch Name <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <input id="inputHorizontalWarning" type="text" class="form-control form-control-warning branch_info_branchname" name="branch_info_branchname">
                                                </div>
                                                <label class="col-md-2 form-control-label">Branch Contact No. <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <input id="inputHorizontalWarning" type="text" class="form-control form-control-warning branch_info_conno" name="branch_info_conno">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="col-md-2 form-control-label">Branch Area <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-10">
                                                    <input id="inputHorizontalWarning" type="text" class="form-control form-control-warning branch_info_area" name="branch_info_area">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="col-md-2 form-control-label">Branch Address <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-10">
                                                    <input id="inputHorizontalWarning" type="text" class="form-control form-control-warning branch_info_address" name="branch_info_address">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="hidden" name="branch_info_id" class="branch_info_id">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-2 form-control-label">Start Contract <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <input id="inputHorizontalWarning" type="text" class="form-control form-control-warning datepicker branch_info_start_contract" name="branch_info_start_contract" placeholder="mm/dd/yyyy">
                                                </div>

                                                <label class="col-md-2 form-control-label">End Contract <span class="asterisk" style="color:red">*</span></label>
                                                <div class="col-md-4">
                                                    <input id="inputHorizontalWarning" type="text" class="form-control form-control-warning datepicker branch_info_end_contract" name="branch_info_end_contract" placeholder="mm/dd/yyyy">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/admin/settings/branch_operator.js');?>"></script>
