...
<div class="content-inner" id="pageActive" data-num="5" data-namecollapse="" data-labelname="Entity">
    ...
    <header class="page-header">
        <div class="container-fluid">
            <h2 class="no-margin-bottom">Sales Return</h2>
        </div>
    ...
    <ul class="breadcrumb">
        <div class="container-fluid">
            ...
            <li class="breadcrumb-item"><a>Sales Return View</a></li>
        </div>
    </ul>
            ...
            <div class="row">        
                <div class="col-lg-12">
                    <div class="card">
                            ...
                            <div class="col-md-12 margin-top-20 row">
                                ...
                                <div class="form-group col-md-12 row">
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 20px;">
                                            <h1>Sales Return View</h1>
                                        </div>

                                        <div class="col-md-12" style="margin-bottom: 20px;">
                                            <h1 class="lblDrretno float-right"></h1>
                                            <br><br>
                                            <h2 class="lblTran lighter float-right"></h2>
                                        </div>

                                        <div class="row col-lg-12 margin-top-20">
                                           <label style="color: gray; font-weight: lighter;">Returned By</label>
                                        </div>
                                        <div class="row col-lg-12 margin-top-20">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <input type="hidden" class="drretno" value="<?php echo $drretno?>">
                        ...
                        <!-- print -->    
                            <div class="print-status">
                             <button type="button" class="btn btn-info btnPrint float-right margin-top-20">Print Sales Return Form</button>
                            </div>
                        </div> <!-- card body -->
                    </div> <!-- card -->
                </div> <!-- col 12 -->                
...
<!-- javascript -->
<script src="<?=base_url('assets/js/entity/customer/customer_salesreturn.js');?>"></script> 
<!-- javascript -->
