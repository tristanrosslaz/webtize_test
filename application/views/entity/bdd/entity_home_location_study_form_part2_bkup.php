...
<div class="content-inner" id="pageActive" data-num="5" data-namecollapse="" data-labelname="Entity">
    ...
    <ul class="breadcrumb">
        <div class="container-fluid">
	    	<li class="breadcrumb-item"><a href="<?=base_url('Main_page/display_page/location_study_form/'.$token);?>">Entity</a></li>      
	        ...
	        <li class="breadcrumb-item">Location Study Form</li>
        </div>
    </ul>
                            	...
                            	<div class="col-md-12">
									...
									<div class="form-group col-sm-6">
										...
										<div class="row form-group">
											...
											<div class="col-sm-8">
												<input type="number" min="1" class="form-control form-control-sm required_fields" name="gov_permit" id="gov_permit">
											</div>
										</div>										
										<div class="row form-group">
									...
									<div class="form-group col-sm-6">
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input readonly type="number" min="1" step="0.01" class="form-control form-control-sm required_fields" name="break_even_gov_permit" id="break_even_gov_permit">
											</div>
										</div>		
										<div class="form-group row">
											<label class="col-sm-4 col-form-label">Marketing Fee and Admin Fee<span class="text-danger"><strong>*</strong></span></label>
