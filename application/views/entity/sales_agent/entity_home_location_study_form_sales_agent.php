...
<div class="content-inner" id="pageActive" data-num="5" data-namecollapse="" data-labelname="Entity">
    ...
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Proposed Location : <?php echo $fis_app_info->lname . ", ".$fis_app_info->fname. " ".$fis_app_info->mname ." ". $fis_app_info->suffixname; ?></li>
        </ol>
    </div>
                            ...
                            <form action="post" id='location_study_form'>
                            	...
                            	<div class="col-md-12">
									<div class="row row-reg">
										...
										<input type="hidden" id="user_access_image_id" value="1" name="user_access_image_id">
										<div class="col-md-4 form-check">
											<div class="form-group">
												<div class="i-checks">
...
<script src="<?=base_url('assets/js/entity/sales_agent/proposed_location.js');?>"></script>
