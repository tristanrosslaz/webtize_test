...
<div class="content-inner" id="pageActive" data-num="5" data-namecollapse="" data-labelname="Entity">
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Franchise Information Sheet Transaction History - Sales Agent</li>
        </ol>
    </div>
...
<script src="<?=base_url('assets/js/entity/sales_agent/fis_transaction_history_sales_agent.js');?>"></script>
