...
<div class="content-inner" id="pageActive" data-num="5" data-namecollapse="" data-labelname="Entity">
    <!-- Page Header-->
    <header hidden class="page-header" data-token="<?=$token?>">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a class="btn btn-primary btn-sm" href="<?=base_url('Main_entity/proposed_location_moni_officer/'.$fis_app_id ."/" .$token);?>" style="float:right">Add Proposed Location</a>
                            ...
                            <a href="<?=base_url('Main_entity/view_pdf_fis_form_moni_officer/'.$fis_app_id."/".$token);?>" class="btn btn-sm btn-primary">View Application Details</a><br>
...
<script src="<?=base_url('assets/js/entity/monitoring_officer/lsf_transaction_history_moni_officer.js');?>"></script>
