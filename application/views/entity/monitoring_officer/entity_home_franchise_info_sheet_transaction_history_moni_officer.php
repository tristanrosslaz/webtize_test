...
<div class="content-inner" id="pageActive" data-num="5" data-namecollapse="" data-labelname="Entity">
     <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Franchise Information Sheet Transaction History - Monitoring Officer</li>
        </ol>
    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                                <div class="form-group row">       
                                    <div class="col-md-12">
                                       <button type="button" style="float:right;" class="btn btn-primary filterBtn">Search</button>
                                    </div>
                                </div>
                            ...
                            <br><br>
                            <div class="table-responsive table_fis" style="display: none">
...
<script src="<?=base_url('assets/js/entity/monitoring_officer/fis_transaction_history_moni_officer.js');?>"></script>
