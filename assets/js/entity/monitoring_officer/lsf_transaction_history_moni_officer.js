$(function(){
	...
	var dataTable = $('#table-grid').DataTable({
		...
		"ajax":{
			url :base_url+"Main_entity/lsf_transaction_history_moni_officer", // json datasource
                            ...
                            success:function(data){
                                ...
                                if(success == 1){
                                    ...
                                    if (status == 1 || status==3) { 
                                        window.open(base_url+"Main_entity/endorsement_for_ocular_view3/"+pl_id +"/"+token,'_blank');
                                    }else if(status == 0){
                                        window.open(base_url+"Main_entity/endorsement_for_ocular/"+pl_id+"/"+token,'_blank');
                                    }else{
                                        window.open(base_url+"Main_entity/endorsement_for_ocular_view3/"+pl_id+"/"+token,'_blank');
                                    }
                                }else{
