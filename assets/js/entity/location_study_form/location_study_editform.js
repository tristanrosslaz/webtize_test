$(function(){
	...
	$("#view_location_study_form :input").prop("disabled", true);
	...
	$(".btnViewApp").click(function(e){
		...
		window.location.href = base_url+"Main_entity/pdf_lsf_form/"+lsf_app_id;
  ...
  //                   $('.btnViewApp').text('Export to PDF');
	...
	$(".btnEditApp").click(function(e){
		...
		$("#preview_location_study_form :input").prop("disabled",false);
	...
	$(".btnCancel").click(function(e){
		...
		$("#preview_location_study_form :input").prop("disabled",true);
		$(".btnEditApp").prop('disabled',false);
		$(".btnViewApp").prop('disabled',false);
	});
	...
	$(".btnSaveApp").click(function(e){
		e.preventDefault();
		var serial = $("#preview_location_study_form").serialize();
	
		$.ajax({
			type: 'post',
			url: base_url+'Main_entity/edit_lsf',
			data: serial,
			beforeSend:function(data){
