$(document).ready(function(){
	...
	dataTable = $('#table-grid').DataTable({
		...
		"ajax":{
			url:base_url+"Main_reports/bd_report_table", // json datasource
			...
			complete: function(data)
			{
				...
				if(response.recordsTotal > 0){	
					...
					list += "<th class='th_total_amount text-right'>"+ response.total +"</th>";
					list += "<th colspan='1' class='text-right'></th>";
					list += " </tr></tfoot>";
