		                        	...
		                        	list += '<div class="">';
			                            list += '<div class="card-header d-flex align-items-center">';
			                                ...
			                                list += '<div class="col-lg-12">';
			                                    list += '<div class="row">';
			                                    list += '<h3>'+res[x].accountin+' - '+res[x].description+' - ('+res[x].deptype+') '+'</h3>';
			                                    list += '</div>';
			                                list += '</div>';
			                            list += '</div>';
			                        list += '</div>';
			                                ...
			                                list += '<table class="table table-striped table-hover table-bordered table_dynamic table_dynamicdetails" cellpadding="0" cellspacing="0" border="0" width="100%">';
			                                    ...
			                                    list += '<tbody>';
			                                        	...
			                                        	for(var i = 0; i < resbodylen; i++){
			                                        		list += '<tr>';
				                                        		list += '<td>'+resbody[i].salesdate+'</td>';
				                                        		list += '<td>'+resbody[i].depdate+'</td>';
				                                        		list += '<td class="text-right">'+accounting.formatMoney(resbody[i].depamount)+'</td>';
			                                        		list += '</tr>';
			                                        	}
			                                    ...
			                                    list += '<tfoot>';
			                                        list += '<tr>';
			                                            ...
			                                            list += '<th class="text-right">'+accounting.formatMoney(res[x].total_amount)+'</th>';
			                                        list += '</tr>';
			                                    list += '</tfoot>';
			                                list += '</table>';
			                            list += '</div>';
						...
						if (reslen > 0) {
							for(var x = 0; x < reslen; x++){
								...
								list += '<div class="card" style="margin-bottom: 0px;">';
			                       ...
			                       list += ' <div class="card-body">';
			                            list += '<div class="table-responsive">';
			                                list += '<table class="table table-striped table-hover table-bordered table_dynamic part2" cellpadding="0" cellspacing="0" border="0" width="100%">';
			                                    // list += '<thead>';
			                                    //     list += '<tr>';
			                                    //         list += '<th>Sales Date</th>';
			                                    //      	list += '<th>Deposit Date</th>';
							...
							list += '<div class="card" style="margin-top: 40px;">';
		                       ...
		                       list += ' <div class="card-body">';
		                            list += '<div class="table-responsive">';
		                                list += '<table class="table table-striped table-hover table-bordered table_dynamic part3" cellpadding="0" cellspacing="0" border="0" width="100%">';
			                                list += '<tr>'
			                                	list += '<td>'+'Total Collection (Cash)'+'</td>';
			                                	list += '<td class="text-right">'+accounting.formatMoney(total_collection_cash)+'</td>';
			                                list += '</tr>';
