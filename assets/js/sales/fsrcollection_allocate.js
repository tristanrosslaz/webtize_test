$(function(){
	...
	var dataTable = $('#table-grid').DataTable({
		...
		"destroy":true,
		"ajax":{
			url :base_url+"Main_sales/table_fsrcollection_allocate", // json datasource
	...
	$("#form1").submit(function(e){
        ...
        serializedForm.push({
         ...
         $.ajax({
                type:'post',
                url:base_url+'Main_sales/tbl_fsr_collectionallocate_save',
                data: serializedForm,
                ...
                if(data.success == 1)
                    {        
                        ...
                        window.setTimeout(function(){
                                 window.location.href=base_url+"Main_sales/fsr_collection_allocate/" + token +'/'+collectionid+'/'+idno;
                          }, 500);
